...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 27. Aug 2020 um 11:29
...
CREATE TABLE `user` (
  ...
  `1malPasswort` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `user` (`id`, `name`, `password`, `rank`, `1malPasswort`, `1malPasswortAblauf`) VALUES
(6, 'michael.stuehle@wilken.de', '82079aaf435a1b8c3c515c9262aceeb0', 'developer', NULL, NULL),
(9, 'sql', '81dc9bdb52d04dc20036dbd8313ed055', 'sql', NULL, NULL);
