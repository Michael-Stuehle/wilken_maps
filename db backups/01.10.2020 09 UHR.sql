...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 01. Okt 2020 um 09:42
...
CREATE TABLE `einstellungen` (
  ...
  `intVal2` int(20) NOT NULL DEFAULT 0
...
INSERT INTO `einstellungen` (`id`, `dark_mode`, `text`, `intVal`, `intVal2`) VALUES
(5, 0, '', 0, 0),
(6, 0, '', 0, 0),
(15, 0, '', 0, 0);
